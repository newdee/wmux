...
const ZH = {
  ...
  "hero.caption": "一段完整录制：分屏、移动、全屏、切窗口、脱离，再接回来。",
  "stat.exe": "个文件就够",
  ...
  "c4.p1":
    "<b>能被脚本驱动。</b> <code>wmux send-keys</code>、<code>wmux capture-pane -p</code>、<code>wmux split-window</code> 可以从外面操作一个 session；在 pane 里面用则不用再写 socket 名。",
  "c4.p2":
